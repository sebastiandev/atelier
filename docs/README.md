...
- New frontend pattern (component prop, route, hook semantics), or a behavior change in an existing one → `frontend.md`
- New visual convention (token family, brand asset, header/card pattern, icon style) → `design-system.md`
