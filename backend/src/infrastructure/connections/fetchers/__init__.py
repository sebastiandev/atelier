...
Phase 2 (this commit): ``jira`` only. Sentry/Honeycomb fall through to
the ``@singledispatch`` default which raises a descriptive
...
from src.domain.connections.configs import ConnectionConfig, JiraConfig
